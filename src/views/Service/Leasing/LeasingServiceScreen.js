...
export default class LeasingServiceScreen extends Component {
        ...
        return (
            ...
            <View style={styles.content}>
                <Header
                    ...
                    centerComponent={{ text: 'Leasing Service', style: { color: '#fff' } }}
                    // rightComponent={{ icon: 'home', color: '#fff' }}
                />
                <ImageBackground source={BG_IMAGE} style={styles.bgImage}>
                    <Text style={styles.text}>Leasing Service</Text>
